          ...
          <article>
            ...
            <div style={{ marginTop: '3rem', padding: '1.5rem', backgroundColor: '#f7f4ee', borderLeft: '3px solid #c9b28f' }}>
              ...
              <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
                {article.authors?.twitter && <a href={article.authors.twitter} target="_blank" rel="noopener noreferrer" style={{ fontSize: '12px', fontWeight: 700, color: '#0e1a2b', textDecoration: 'none' }}>𝕏 Twitter</a>}
                {article.authors?.instagram && <a href={article.authors.instagram} target="_blank" rel="noopener noreferrer" style={{ fontSize: '12px', fontWeight: 700, color: '#0e1a2b', textDecoration: 'none' }}>Instagram</a>}
                {article.authors?.linkedin && <a href={article.authors.linkedin} target="_blank" rel="noopener noreferrer" style={{ fontSize: '12px', fontWeight: 700, color: '#0e1a2b', textDecoration: 'none' }}>LinkedIn</a>}
                {article.authors?.website && <a href={article.authors.website} target="_blank" rel="noopener noreferrer" style={{ fontSize: '12px', fontWeight: 700, color: '#0e1a2b', textDecoration: 'none' }}>Website</a>}
              </div>
            </div>
          </article>
