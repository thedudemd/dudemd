  ...
  return (
    <main>
      ...
      {article.layout === 'magazine' ? (
        ...
        <>{article.show_hero !== false && article.cover_image_url && (<div style={{ width: '100%', aspectRatio: '16/9', maxHeight: '520px', overflow: 'hidden' }}><img src={article.cover_image_url} alt={`Cover image for ${article.title}`} style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center center', display: 'block' }} /></div>)}<OptinDisplay categoryId={article.category_id} /></>
      )}
