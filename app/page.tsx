          ...
          <div style={{ display: 'flex', gap: '3rem', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', gap: '2.5rem', overflowX: 'auto', scrollbarWidth: 'none' }}>
              {articles.slice(0, 4).map((a) => (
                <Link key={a.slug} href={`/articles/${a.slug}`} style={{ fontSize: '11px', fontWeight: 600, color: '#0e1a2b', textDecoration: 'none', whiteSpace: 'nowrap', opacity: 0.85 }}>
                  {a.title}
                </Link>
              ))}
            </div>
      ...
      <section style={{ padding: '2.5rem 0 0', borderBottom: '1px solid #ede8df' }}>
        <div className="container-content">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: '0', alignItems: 'stretch' }}>
            ...
            {/* SECONDARY TWO STACK */}
            <div style={{ paddingLeft: '2rem', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', gap: '0' }}>
