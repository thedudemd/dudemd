...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* RIGHT PANEL */}
      <div className="hidden lg:block lg:w-[55%] relative overflow-hidden" style={{ backgroundColor: '#0e1a2b' }}>
        <video
          autoPlay
          muted
          loop
        ...
        >
          <source src="https://res.cloudinary.com/dligiz9tp/video/upload/v1779310943/Modern_Wellness_For_Real_Life_joaivh.mp4" type="video/mp4" />
        </video>
        <div
