  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#0e1a2b', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ backgroundColor: '#f7f4ee', padding: '3rem', width: '100%', maxWidth: '400px' }}>
        ...
        {error && (
          <p style={{ fontSize: '13px', color: '#c0392b', backgroundColor: '#fdecea', padding: '0.75rem', marginBottom: '1rem', textAlign: 'center' }}>{error}</p>
        )}
        ...
        <div style={{ marginBottom: '1rem' }}>
          ...
          <input type="email" value={email} onChange={e => setEmail(e.target.value)}
            style={{ width: '100%', padding: '0.75rem', border: '1px solid #ede8df', fontSize: '14px', outline: 'none', boxSizing: 'border-box', backgroundColor: '#fff' }} />
        </div>
        ...
        <button onClick={handleLogin} disabled={loading}
          style={{ width: '100%', padding: '0.875rem', backgroundColor: '#0e1a2b', color: '#f7f4ee', fontWeight: 700, fontSize: '13px', letterSpacing: '0.08em', textTransform: 'uppercase', border: 'none', cursor: 'pointer' }}>
