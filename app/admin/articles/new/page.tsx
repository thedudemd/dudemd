          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div>
              ...
              <div style={{ border: '1px solid #ede8df', minHeight: '500px', padding: form.layout === 'magazine' ? '2rem' : form.layout === 'longform' ? '2.5rem 3rem' : '1.5rem', backgroundColor: form.layout === 'longform' ? '#0e1a2b' : '#fff', color: form.layout === 'longform' ? '#f7f4ee' : '#0e1a2b', fontFamily: form.layout === 'magazine' ? 'Georgia, serif' : 'inherit', lineHeight: 1.8, borderTop: 'none' }}>
                ...
                <button onClick={() => editor?.chain().focus().redo().run()} title="Redo" style={{ padding: '0.3rem 0.5rem', background: 'transparent', border: 'none', cursor: 'pointer', borderRadius: 3, color: '#f7f4ee' }}>
              ...
              <div style={{
                ...
                minHeight: '500px',
                padding: form.layout === 'magazine' ? '2rem' : form.layout === 'longform' ? '2.5rem 3rem' : '1.5rem',
                backgroundColor: form.layout === 'longform' ? '#0e1a2b' : '#fff',
                color: form.layout === 'longform' ? '#f7f4ee' : '#0e1a2b',
                fontFamily: form.layout === 'magazine' ? 'Georgia, serif' : 'inherit',
                fontSize: form.layout === 'longform' ? '17px' : '15px',
                lineHeight: 1.8,
                borderTop: 'none'
              }}>
                <EditorContent editor={editor} />
