    ...
    <header style={{ backgroundColor: '#0e1a2b', position: 'sticky', top: 0, zIndex: 200 }}>
      ...
      <div className="container-content" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '4.5rem' }}>
        <Link href="/" style={{ textDecoration: 'none', flexShrink: 0 }}>
          <img src="/md-transparent.svg" alt="DudeMD" style={{ height: "60px", width: "auto", objectFit: "contain", filter: "brightness(0) saturate(100%) invert(78%) sepia(28%) saturate(500%) hue-rotate(5deg) brightness(95%) contrast(90%)" }} />
        </Link>
