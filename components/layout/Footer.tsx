        ...
        <div className="container-content">
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
            ...
            <div style={{ textAlign: 'right' }}>
              <p style={{ margin: '0 0 -8px 0', textAlign: 'center', fontSize: '9px', fontWeight: 400, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(247,244,238,0.4)' }}>A publication of</p>
