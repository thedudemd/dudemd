      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0.875rem 0', borderTop: '1px solid var(--color-border)', borderBottom: '1px solid var(--color-border)', margin: '1.5rem 0' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1.25rem' }}>
          ...
          <a href={`https://www.threads.net/intent/post?text=${encodedTitle}%20${encoded}`} target="_blank" rel="noopener noreferrer" title="Share on Threads" style={{ color: '#9a9085', display: 'flex', textDecoration: 'none' }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M12.186 24h-.007c-3.581-.024-6.334-1.205-8.184-3.509C2.35 18.44 1.5 15.586 1.472 12.01v-.017c.03-3.579.879-6.43 2.525-8.482C5.845 1.205 8.6.024 12.18 0h.014c2.746.02 5.043.725 6.826 2.098 1.677 1.29 2.859 3.13 3.513 5.465l-2.388.65c-1.044-3.82-3.564-5.81-7.951-5.839-2.904.02-5.036.86-6.334 2.496-1.232 1.55-1.866 3.957-1.889 7.156.023 3.196.657 5.602 1.887 7.15 1.298 1.636 3.43 2.478 6.334 2.499 2.608.02 4.609-.635 5.96-2.248.98-1.17 1.429-2.943 1.337-5.27l-.004-.11h-7.292v-2.304h9.669l.006.12c.157 3.062-.48 5.502-1.892 7.25-1.717 2.14-4.253 3.22-7.547 3.243z"/></svg>
          </a>
